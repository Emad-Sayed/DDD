...
{
    public class ListAllBrandsQuery : IRequest<ListEntityVM<BrandVM>>
    {
        public class Handler : IRequestHandler<ListAllBrandsQuery, ListEntityVM<BrandVM>>
        {
            ...
            public async Task<ListEntityVM<BrandVM>> Handle(ListAllBrandsQuery request, CancellationToken cancellationToken)
            {
