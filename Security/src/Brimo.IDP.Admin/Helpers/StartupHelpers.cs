...
using Brimo.IDP.Admin.ExceptionHandling;
using Brimo.IDP.Admin.Configuration;
using Brimo.IDP.Admin.Configuration.ApplicationParts;
using Brimo.IDP.Admin.Configuration.Constants;
using Brimo.IDP.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories.Interfaces;
using Brimo.IDP.Admin.Helpers.Localization;
using System.Linq;
...
namespace Brimo.IDP.Admin.Helpers
{
